...
base='YOUR SITE HERE'
ADDON=xbmcaddon.Addon(id='kodi.17')
...
def CATEGORIES():
    link = OPEN_URL('https://www.dropbox.com/s/xi4wo8rv347hh89/kodi17.txt?dl=1').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("kodi.17","Downloading ",'', 'Please Wait')
